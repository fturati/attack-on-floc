...
import logging
from utils import OldTimer # replaced with more complete code where took inspiration from in codetiming
...
if __name__ == '__main__':
    ...
    from attack.generating_histories import generate_from_traintest  # circular import if imported for whole file
    import pickle
