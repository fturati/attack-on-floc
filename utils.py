...
def init_loggers(log_to_stdout=False, log_to_file=True, filename='empty', fh_lvl=logging.INFO, sh_lvl=logging.INFO):
    ...
    if log_to_file:
        ...
        f_handler = logging.FileHandler(f'./logs/{filename}_[{timestamp}].log', 'w', 'utf-8')
